package org.spring.springboot.rpc.server.server;
...
import static org.spring.springboot.rpc.server.config.RabbitConfig.QUEUE_ASYNC_RPC;
import static org.spring.springboot.rpc.server.config.RabbitConfig.QUEUE_ASYNC_RPC_WITH_FIXED_REPLY;
        ...
        asyncResult.addCallback(new ListenableFutureCallback<String>() {
            ...
            public void onSuccess(String result) {
                amqpTemplate.convertAndSend(replyTo, (Object) result, m -> {
                    ...
                    m.getMessageProperties().setCorrelationId(String.valueOf(correlationId));
                    return m;
                });
            }
